...
namespace AmazonScrapper.Data.Parser.Search
{
	...
	public class Series_Fr : Series
	{
		public Series_Fr(HtmlNode node) : base(node)
		{
		}
    ...
    public class Series_De : Series
    {
        public Series_De(HtmlNode node) : base(node)
        {
        }
    ...
    public class Series_Es : Series
    {
        public Series_Es(HtmlNode node) : base(node)
        {
        }
